...
function woocommerce_twocheckoutpp(){
    ...
    class WC_Gateway_Twocheckoutpp extends WC_Payment_Gateway{
        ...
        function is_valid_for_use() {
            if ( ! in_array( get_woocommerce_currency(), apply_filters( 'woocommerce_twocheckoutpp_supported_currencies', array('AUD', 'AED', 'BRL', 'CAD', 'MXN', 'NZD', 'HKD', 'SGD', 'USD', 'EUR', 'JPY', 'TRY', 'NOK', 'DKK', 'ILS', 'MYR', 'PHP', 'SEK', 'CHF', 'GBP', 'ARS', 'INR', 'LTL', 'RON', 'RUB', 'ZAR' ) ) ) ) return false;
